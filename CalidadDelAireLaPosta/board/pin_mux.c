...
- {pin_num: '93', pin_signal: PTD0/LLWU_P12/SPI0_PCS0/UART2_RTS_b/FTM3_CH0/FB_ALE/FB_CS1_b/FB_TS_b, label: 'J2[6]', identifier: LED_3}
...
- {pin_num: '83', pin_signal: ADC1_SE7b/PTC11/LLWU_P11/I2C1_SDA/FTM3_CH7/I2S0_RXD1/FB_RW_b, label: 'J4[10]', identifier: LEDL;LED_1}
- {pin_num: '82', pin_signal: ADC1_SE6b/PTC10/I2C1_SCL/FTM3_CH6/I2S0_RX_FS/FB_AD5, label: 'J4[12]', identifier: LED_2}
...
- pin_list:
  ...
  - {pin_num: '32', peripheral: UART4, signal: RX, pin_signal: ADC0_SE18/PTE25/UART4_RX/I2C0_SDA/EWM_IN, identifier: ''}
  - {pin_num: '31', peripheral: UART4, signal: TX, pin_signal: ADC0_SE17/PTE24/UART4_TX/I2C0_SCL/EWM_OUT_b, identifier: ''}
  ...
  - {pin_num: '83', peripheral: GPIOC, signal: 'GPIO, 11', pin_signal: ADC1_SE7b/PTC11/LLWU_P11/I2C1_SDA/FTM3_CH7/I2S0_RXD1/FB_RW_b, identifier: LED_1, direction: OUTPUT,
    gpio_init_state: 'false'}
  - {pin_num: '82', peripheral: GPIOC, signal: 'GPIO, 10', pin_signal: ADC1_SE6b/PTC10/I2C1_SCL/FTM3_CH6/I2S0_RX_FS/FB_AD5, direction: OUTPUT, gpio_init_state: 'false'}
  - {pin_num: '93', peripheral: GPIOD, signal: 'GPIO, 0', pin_signal: PTD0/LLWU_P12/SPI0_PCS0/UART2_RTS_b/FTM3_CH0/FB_ALE/FB_CS1_b/FB_TS_b, direction: OUTPUT, gpio_init_state: 'false'}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t RF_WIFI_CE_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTB20 (pin 66)  */
    GPIO_PinInit(BOARD_RF_WIFI_CE_GPIO, BOARD_RF_WIFI_CE_PIN, &RF_WIFI_CE_config);
    ...
    GPIO_PinInit(BOARD_LED_2_GPIO, BOARD_LED_2_PIN, &LED_2_config);
    ...
    GPIO_PinInit(BOARD_LED_1_GPIO, BOARD_LED_1_PIN, &LED_1_config);
    ...
    GPIO_PinInit(BOARD_LED_3_GPIO, BOARD_LED_3_PIN, &LED_3_config);
    ...
    /* PORTC0 (pin 70) is configured as SPI0_PCS4 */
    PORT_SetPinMux(PORTC, 0U, kPORT_MuxAlt2);

    /* PORTC10 (pin 82) is configured as PTC10 */
    PORT_SetPinMux(BOARD_LED_2_PORT, BOARD_LED_2_PIN, kPORT_MuxAsGpio);

    /* PORTC11 (pin 83) is configured as PTC11 */
    PORT_SetPinMux(BOARD_LED_1_PORT, BOARD_LED_1_PIN, kPORT_MuxAsGpio);

    /* PORTD0 (pin 93) is configured as PTD0 */
    PORT_SetPinMux(BOARD_LED_3_PORT, BOARD_LED_3_PIN, kPORT_MuxAsGpio);
...
- options: {prefix: BOARD_, coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: '67', peripheral: GPIOB, signal: 'GPIO, 21', pin_signal: PTB21/SPI2_SCK/FB_AD30/CMP1_OUT, identifier: '', direction: OUTPUT, gpio_init_state: 'true',
...
void BOARD_InitLEDsPins(void)
{
    ...
    const port_pin_config_t portb21_pin67_config = {/* Internal pull-up/down resistor is disabled */
                                                    kPORT_PullDisable,
    ...
    PORT_SetPinConfig(PORTB, 21U, &portb21_pin67_config);
