...
#define BOARD_UART2_TX_PORT PORTD               /*!<@brief PORT peripheral base pointer */
#define BOARD_UART2_TX_PIN 3U                   /*!<@brief PORT pin number */
#define BOARD_UART2_TX_PIN_MASK (1U << 3U)      /*!<@brief PORT pin mask */
                                                /* @} */
...
/* Symbols to be used with PORT driver */
#define BOARD_UART2_RX_PORT PORTD               /*!<@brief PORT peripheral base pointer */
#define BOARD_UART2_RX_PIN 2U                   /*!<@brief PORT pin number */
#define BOARD_UART2_RX_PIN_MASK (1U << 2U)      /*!<@brief PORT pin mask */
                                                /* @} */
...
#define BOARD_RF_WIFI_CE_GPIO GPIOB                /*!<@brief GPIO peripheral base pointer */
#define BOARD_RF_WIFI_CE_GPIO_PIN_MASK (1U << 20U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_RF_WIFI_CE_PORT PORTB                /*!<@brief PORT peripheral base pointer */
#define BOARD_RF_WIFI_CE_PIN 20U                   /*!<@brief PORT pin number */
#define BOARD_RF_WIFI_CE_PIN_MASK (1U << 20U)      /*!<@brief PORT pin mask */
                                                   /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_LED_1_GPIO GPIOC                /*!<@brief GPIO peripheral base pointer */
#define BOARD_LED_1_GPIO_PIN_MASK (1U << 11U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_LED_1_PORT PORTC                /*!<@brief PORT peripheral base pointer */
#define BOARD_LED_1_PIN 11U                   /*!<@brief PORT pin number */
#define BOARD_LED_1_PIN_MASK (1U << 11U)      /*!<@brief PORT pin mask */
                                              /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_LED_2_GPIO GPIOC                /*!<@brief GPIO peripheral base pointer */
#define BOARD_LED_2_GPIO_PIN_MASK (1U << 10U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_LED_2_PORT PORTC                /*!<@brief PORT peripheral base pointer */
#define BOARD_LED_2_PIN 10U                   /*!<@brief PORT pin number */
#define BOARD_LED_2_PIN_MASK (1U << 10U)      /*!<@brief PORT pin mask */
                                              /* @} */
...
/* Symbols to be used with GPIO driver */
#define BOARD_LED_3_GPIO GPIOD               /*!<@brief GPIO peripheral base pointer */
#define BOARD_LED_3_GPIO_PIN_MASK (1U << 0U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_LED_3_PORT PORTD               /*!<@brief PORT peripheral base pointer */
#define BOARD_LED_3_PIN 0U                   /*!<@brief PORT pin number */
#define BOARD_LED_3_PIN_MASK (1U << 0U)      /*!<@brief PORT pin mask */
                                             /* @} */
