 ...
 */
int UART_RTOS_Receive(uart_rtos_handle_t *handle, uint8_t *buffer, uint32_t length, size_t *received, uint32_t max_wait_ms)
{
    EventBits_t ev;
    size_t n              = 0;
    ...
    ev = xEventGroupWaitBits(handle->rxEvent,
                             ...
                             pdTRUE, pdFALSE, pdMS_TO_TICKS(max_wait_ms));
